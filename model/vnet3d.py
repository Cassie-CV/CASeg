...
class OutputTransition(nn.Module):
    def __init__(self, in_channels, classes, elu):
        ...
        # self.conv1_1 = nn.Conv3d(classes, classes, kernel_size=3, padding=2)
        self.bn1 = torch.nn.BatchNorm3d(classes)
        # self.bn1_1 = torch.nn.BatchNorm3d(classes)
    ...
    def forward(self, x):
        ...
        out = self.relu1(self.bn1(self.conv1(x)))
        # out = self.relu1(self.bn1_1(self.conv1_1(out)))
        out = self.conv2(out)
        return out
...
class VNet(nn.Module):
    ...
    """
    # classes, channels
    def __init__(self,  classes=2, in_channels=1,elu=False):
