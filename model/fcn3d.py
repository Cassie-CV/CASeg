...
class FCN_Net(nn.Module):
 # classes=1, in_channels=1
    def __init__(self,classes = 1, in_channels =1):
        super().__init__()
        # conv1
        ...
        self.score_fr = nn.Conv3d(512, classes, 1)
        self.score_pool3 = nn.Conv3d(32, classes, 1)
        self.score_pool4 = nn.Conv3d(64, classes, 1)
